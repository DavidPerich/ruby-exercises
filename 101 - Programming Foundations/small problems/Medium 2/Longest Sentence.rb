...
# book =  File.read("launch_school/101_109/small problems/Medium 2/pg84.epub")
 

 
BOOK = "Four score and seven years ago our fathers brought forth
...
longest_word(File.read("book.txt"))
