...
=begin
input is a matrix represented as an array of arrays. 
Output is an array of arrays. 

Problem 

My hunch is it has something to do with moving the index
...
Patter there is the index in its final array is the array it moves to. 
