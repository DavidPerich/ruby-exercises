...
# All of these collection classes include the Enumerable module, which means they
# have access to an each method, as well as many other iterative methods such as map, reduce, select, and more.
