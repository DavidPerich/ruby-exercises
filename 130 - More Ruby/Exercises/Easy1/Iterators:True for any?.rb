...
# If the block returns a value of true for any element, then #any? returns true. Otherwise, #any? returns false. Note in particular that #any? will stop searching the collection the first time the block returns true.
...
# should stop seraching collection if returns true 
# if empty should return false 
#   return true if any element 
  require 'pry'
